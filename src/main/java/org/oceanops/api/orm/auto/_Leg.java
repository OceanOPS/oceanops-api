...
public abstract class _Leg extends BaseDataObject {
    ...
    public static final BaseProperty<Wkt> END_POINT = PropertyFactory.createBase("endPoint", Wkt.class);
    ...
    public static final BaseProperty<Wkt> START_POINT = PropertyFactory.createBase("startPoint", Wkt.class);

    protected LocalDateTime endDate;
    protected Wkt endPoint;
    protected BigDecimal id;
    protected LocalDateTime startDate;
    protected Wkt startPoint;
    ...
    public void setEndPoint(Wkt endPoint) {
        beforePropertyWrite("endPoint", this.endPoint, endPoint);
        this.endPoint = endPoint;
    }

    public Wkt getEndPoint() {
    ...
    public void setStartPoint(Wkt startPoint) {
        beforePropertyWrite("startPoint", this.startPoint, startPoint);
        this.startPoint = startPoint;
    }

    public Wkt getStartPoint() {
    ...
    protected void readState(ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        this.endPoint = (Wkt)in.readObject();
        this.id = (BigDecimal)in.readObject();
        this.startDate = (LocalDateTime)in.readObject();
        this.startPoint = (Wkt)in.readObject();
    }
