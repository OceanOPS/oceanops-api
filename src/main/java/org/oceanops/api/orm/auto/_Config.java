...
public abstract class _Config extends BaseDataObject {
    ...
    public static final EntityProperty<TimePeriod> OBS_SCHEDULE = PropertyFactory.createEntity("obsSchedule", TimePeriod.class);
    ...
    public void setObsSchedule(TimePeriod obsSchedule) {
        setToOneTarget("obsSchedule", obsSchedule, true);
    }

    public TimePeriod getObsSchedule() {
        return (TimePeriod)readProperty("obsSchedule");
    }
    ...
    protected void readState(ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        this.obsSchedule = in.readObject();
