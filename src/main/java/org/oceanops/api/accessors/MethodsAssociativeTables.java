...
import org.oceanops.api.entities.AgencyEntity;
import org.oceanops.api.entities.ContactEntity;
import org.oceanops.api.entities.RoleEntity;
...
public class MethodsAssociativeTables {
	...
	public ArrayList<VariableEntity> FindPtfVariables(long ptf_id) {
    	...
    	while (ID_itr.hasNext())
    	   {
    		int a= ID_itr.next();
    		SQLTemplate query_5 = new SQLTemplate(org.oceanops.api.orm.Variable.class, "select * from variable  where ID="+a);
