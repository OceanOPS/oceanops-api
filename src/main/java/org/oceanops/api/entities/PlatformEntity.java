...
public class PlatformEntity implements Serializable{
	...
	public PlatformEntity(Ptf ptf) {
    	...
    	this.setDBUpdateDate(Utils.GetIsoDate(ptf.getUpdateDate()));
	}
	...
	public String toCSV(){
		...
		csv.append(this.getId() + Utils.CSV_SEPARATOR + this.getRef() + Utils.CSV_SEPARATOR);
	...
	@XmlElement
	public String getDBInsertDate() {
		return dbInsertDate;
	}

	public void setDBInsertDate(String dbInsertDate) {
