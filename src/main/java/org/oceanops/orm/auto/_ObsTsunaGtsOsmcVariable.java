 ...
 */
public abstract class _ObsTsunaGtsOsmcVariable extends BaseDataObject {
    ...
    public static final EntityProperty<ObsTsunaGtsOsmc> OBS = PropertyFactory.createEntity("obs", ObsTsunaGtsOsmc.class);
