...
/**
 * Class _VVosObsMonthly was generated by Cayenne.
 * It is probably a good idea to avoid changing this class manually,
 * since it may be overwritten next time code is regenerated.
 * If you need to make any customizations, please use subclass.
 */
public abstract class _VVosObsMonthly extends CayenneDataObject {
    ...
    public void setTimeliness(Integer timeliness) {
        writeProperty(TIMELINESS_PROPERTY, timeliness);
    }
    public Integer getTimeliness() {
        return (Integer)readProperty(TIMELINESS_PROPERTY);
    }
