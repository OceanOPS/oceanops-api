...
public class TimeZoneType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            ReferenceType lhsTimeZone;
            lhsTimeZone = this.getTimeZone();
            ReferenceType rhsTimeZone;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TimeZoneType) {
            final TimeZoneType copy = ((TimeZoneType) draftCopy);
            {
                ...
                if (timeZoneShouldBeCopiedAndSet == Boolean.TRUE) {
                    ReferenceType sourceTimeZone;
                    sourceTimeZone = this.getTimeZone();
                    ReferenceType copyTimeZone = ((ReferenceType) strategy.copy(LocatorUtils.property(locator, "timeZone", sourceTimeZone), sourceTimeZone, this.isSetTimeZone()));
