...
public class GeospatialLocationType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            ReferenceType theCoordinateReferenceSystem;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            ReferenceType lhsCoordinateReferenceSystem;
            lhsCoordinateReferenceSystem = this.getCoordinateReferenceSystem();
            ReferenceType rhsCoordinateReferenceSystem;
        ...
        if (draftCopy instanceof GeospatialLocationType) {
            ...
            }
            {
                ...
                if (coordinateReferenceSystemShouldBeCopiedAndSet == Boolean.TRUE) {
                    ReferenceType sourceCoordinateReferenceSystem;
                    sourceCoordinateReferenceSystem = this.getCoordinateReferenceSystem();
                    ReferenceType copyCoordinateReferenceSystem = ((ReferenceType) strategy.copy(LocatorUtils.property(locator, "coordinateReferenceSystem", sourceCoordinateReferenceSystem), sourceCoordinateReferenceSystem, this.isSetCoordinateReferenceSystem()));
