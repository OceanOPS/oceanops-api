    ...
    implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            List<ObservingFacilityType.TimeZone> theTimeZone;
            theTimeZone = (this.isSetTimeZone()?this.getTimeZone():null);
            strategy.appendField(locator, this, "timeZone", buffer, theTimeZone, this.isSetTimeZone());
        }
        {
        ...
        {
            List<ObservingFacilityType.Population> thePopulation;
            thePopulation = (this.isSetPopulation()?this.getPopulation():null);
            strategy.appendField(locator, this, "population", buffer, thePopulation, this.isSetPopulation());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            List<ObservingFacilityType.TimeZone> lhsTimeZone;
            lhsTimeZone = (this.isSetTimeZone()?this.getTimeZone():null);
            List<ObservingFacilityType.TimeZone> rhsTimeZone;
            rhsTimeZone = (that.isSetTimeZone()?that.getTimeZone():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "timeZone", lhsTimeZone), LocatorUtils.property(thatLocator, "timeZone", rhsTimeZone), lhsTimeZone, rhsTimeZone, this.isSetTimeZone(), that.isSetTimeZone())) {
                return false;
            }
        }
        {
        ...
        {
            List<ObservingFacilityType.Population> lhsPopulation;
            lhsPopulation = (this.isSetPopulation()?this.getPopulation():null);
            List<ObservingFacilityType.Population> rhsPopulation;
            rhsPopulation = (that.isSetPopulation()?that.getPopulation():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "population", lhsPopulation), LocatorUtils.property(thatLocator, "population", rhsPopulation), lhsPopulation, rhsPopulation, this.isSetPopulation(), that.isSetPopulation())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            List<ObservingFacilityType.TimeZone> theTimeZone;
            theTimeZone = (this.isSetTimeZone()?this.getTimeZone():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "timeZone", theTimeZone), currentHashCode, theTimeZone, this.isSetTimeZone());
        }
        {
            XMLGregorianCalendar theDateClosed;
            theDateClosed = this.getDateClosed();
        ...
        }
        {
            List<ObservingFacilityType.Population> thePopulation;
            thePopulation = (this.isSetPopulation()?this.getPopulation():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "population", thePopulation), currentHashCode, thePopulation, this.isSetPopulation());
        }
        {
            List<ObservingCapabilityPropertyType> theObservation;
            theObservation = (this.isSetObservation()?this.getObservation():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ObservingFacilityType) {
            ...
            {
                Boolean timeZoneShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTimeZone());
                if (timeZoneShouldBeCopiedAndSet == Boolean.TRUE) {
                    List<ObservingFacilityType.TimeZone> sourceTimeZone;
                    sourceTimeZone = (this.isSetTimeZone()?this.getTimeZone():null);
                    @SuppressWarnings("unchecked")
                    List<ObservingFacilityType.TimeZone> copyTimeZone = ((List<ObservingFacilityType.TimeZone> ) strategy.copy(LocatorUtils.property(locator, "timeZone", sourceTimeZone), sourceTimeZone, this.isSetTimeZone()));
                    copy.unsetTimeZone();
                    if (copyTimeZone!= null) {
                        List<ObservingFacilityType.TimeZone> uniqueTimeZonel = copy.getTimeZone();
                        uniqueTimeZonel.addAll(copyTimeZone);
                    }
                } else {
                    if (timeZoneShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.unsetTimeZone();
                    }
                }
            }
            ...
            {
                Boolean populationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetPopulation());
                if (populationShouldBeCopiedAndSet == Boolean.TRUE) {
                    List<ObservingFacilityType.Population> sourcePopulation;
                    sourcePopulation = (this.isSetPopulation()?this.getPopulation():null);
                    @SuppressWarnings("unchecked")
                    List<ObservingFacilityType.Population> copyPopulation = ((List<ObservingFacilityType.Population> ) strategy.copy(LocatorUtils.property(locator, "population", sourcePopulation), sourcePopulation, this.isSetPopulation()));
                    copy.unsetPopulation();
                    if (copyPopulation!= null) {
                        List<ObservingFacilityType.Population> uniquePopulationl = copy.getPopulation();
                        uniquePopulationl.addAll(copyPopulation);
                    }
                } else {
                    if (populationShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.unsetPopulation();
                    }
                }
            }
        ...
        implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
            ...
            final ObservingFacilityType.Population that = ((ObservingFacilityType.Population) object);
            {
                PopulationType lhsPopulation;
                lhsPopulation = this.getPopulation();
                PopulationType rhsPopulation;
        ...
        public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
            final Object draftCopy = ((target == null)?createNewInstance():target);
            super.copyTo(locator, draftCopy, strategy);
            if (draftCopy instanceof ObservingFacilityType.Population) {
                final ObservingFacilityType.Population copy = ((ObservingFacilityType.Population) draftCopy);
                {
                    Boolean populationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetPopulation());
                    if (populationShouldBeCopiedAndSet == Boolean.TRUE) {
                        PopulationType sourcePopulation;
                        sourcePopulation = this.getPopulation();
                        PopulationType copyPopulation = ((PopulationType) strategy.copy(LocatorUtils.property(locator, "population", sourcePopulation), sourcePopulation, this.isSetPopulation()));
        ...
        implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
            ...
            final ObservingFacilityType.TimeZone that = ((ObservingFacilityType.TimeZone) object);
            {
                TimeZoneType lhsTimeZone;
                lhsTimeZone = this.getTimeZone();
                TimeZoneType rhsTimeZone;
        ...
        public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
            final Object draftCopy = ((target == null)?createNewInstance():target);
            super.copyTo(locator, draftCopy, strategy);
            if (draftCopy instanceof ObservingFacilityType.TimeZone) {
                final ObservingFacilityType.TimeZone copy = ((ObservingFacilityType.TimeZone) draftCopy);
                {
                    Boolean timeZoneShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTimeZone());
                    if (timeZoneShouldBeCopiedAndSet == Boolean.TRUE) {
                        TimeZoneType sourceTimeZone;
                        sourceTimeZone = this.getTimeZone();
                        TimeZoneType copyTimeZone = ((TimeZoneType) strategy.copy(LocatorUtils.property(locator, "timeZone", sourceTimeZone), sourceTimeZone, this.isSetTimeZone()));
