...
public class SamplingType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            BigInteger theSamplesPerTimePeriod;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            BigInteger lhsSamplesPerTimePeriod;
            lhsSamplesPerTimePeriod = this.getSamplesPerTimePeriod();
            BigInteger rhsSamplesPerTimePeriod;
        ...
        if (draftCopy instanceof SamplingType) {
            ...
            }
            {
                ...
                if (samplesPerTimePeriodShouldBeCopiedAndSet == Boolean.TRUE) {
                    BigInteger sourceSamplesPerTimePeriod;
                    sourceSamplesPerTimePeriod = this.getSamplesPerTimePeriod();
                    BigInteger copySamplesPerTimePeriod = ((BigInteger) strategy.copy(LocatorUtils.property(locator, "samplesPerTimePeriod", sourceSamplesPerTimePeriod), sourceSamplesPerTimePeriod, this.isSetSamplesPerTimePeriod()));
