...
public class FacilitySetPropertyType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final FacilitySetPropertyType that = ((FacilitySetPropertyType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof FacilitySetPropertyType) {
            final FacilitySetPropertyType copy = ((FacilitySetPropertyType) draftCopy);
            {
