...
public class FrequenciesPropertyType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            FrequenciesType theFrequencies;
            theFrequencies = this.getFrequencies();
            strategy.appendField(locator, this, "frequencies", buffer, theFrequencies, this.isSetFrequencies());
        }
        {
            boolean theOwns;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final FrequenciesPropertyType that = ((FrequenciesPropertyType) object);
        {
            FrequenciesType lhsFrequencies;
            lhsFrequencies = this.getFrequencies();
            FrequenciesType rhsFrequencies;
            rhsFrequencies = that.getFrequencies();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "frequencies", lhsFrequencies), LocatorUtils.property(thatLocator, "frequencies", rhsFrequencies), lhsFrequencies, rhsFrequencies, this.isSetFrequencies(), that.isSetFrequencies())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            FrequenciesType theFrequencies;
            theFrequencies = this.getFrequencies();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "frequencies", theFrequencies), currentHashCode, theFrequencies, this.isSetFrequencies());
        }
        {
            boolean theOwns;
            theOwns = (this.isSetOwns()?this.isOwns():false);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof FrequenciesPropertyType) {
            final FrequenciesPropertyType copy = ((FrequenciesPropertyType) draftCopy);
            {
                Boolean frequenciesShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetFrequencies());
                if (frequenciesShouldBeCopiedAndSet == Boolean.TRUE) {
                    FrequenciesType sourceFrequencies;
                    sourceFrequencies = this.getFrequencies();
                    FrequenciesType copyFrequencies = ((FrequenciesType) strategy.copy(LocatorUtils.property(locator, "frequencies", sourceFrequencies), sourceFrequencies, this.isSetFrequencies()));
                    copy.setFrequencies(copyFrequencies);
                } else {
                    if (frequenciesShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.frequencies = null;
                    }
                }
            }
            {
