    ...
    implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean isSetUncertaintyEvalProc() {
        return (this.uncertaintyEvalProc!= null);
    }
    ...
    public boolean isSetSubEquipment() {
        return ((this.subEquipment!= null)&&(!this.subEquipment.isEmpty()));
    }

    public void unsetSubEquipment() {
        this.subEquipment = null;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            ReferenceType theUncertaintyEvalProc;
            theUncertaintyEvalProc = this.getUncertaintyEvalProc();
            strategy.appendField(locator, this, "uncertaintyEvalProc", buffer, theUncertaintyEvalProc, this.isSetUncertaintyEvalProc());
        }
        {
        ...
        {
            List<EquipmentType.SubEquipment> theSubEquipment;
            theSubEquipment = (this.isSetSubEquipment()?this.getSubEquipment():null);
            strategy.appendField(locator, this, "subEquipment", buffer, theSubEquipment, this.isSetSubEquipment());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            ReferenceType lhsUncertaintyEvalProc;
            lhsUncertaintyEvalProc = this.getUncertaintyEvalProc();
            ReferenceType rhsUncertaintyEvalProc;
            rhsUncertaintyEvalProc = that.getUncertaintyEvalProc();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "uncertaintyEvalProc", lhsUncertaintyEvalProc), LocatorUtils.property(thatLocator, "uncertaintyEvalProc", rhsUncertaintyEvalProc), lhsUncertaintyEvalProc, rhsUncertaintyEvalProc, this.isSetUncertaintyEvalProc(), that.isSetUncertaintyEvalProc())) {
                return false;
            }
        }
        {
        ...
        {
            List<EquipmentType.SubEquipment> lhsSubEquipment;
            lhsSubEquipment = (this.isSetSubEquipment()?this.getSubEquipment():null);
            List<EquipmentType.SubEquipment> rhsSubEquipment;
            rhsSubEquipment = (that.isSetSubEquipment()?that.getSubEquipment():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "subEquipment", lhsSubEquipment), LocatorUtils.property(thatLocator, "subEquipment", rhsSubEquipment), lhsSubEquipment, rhsSubEquipment, this.isSetSubEquipment(), that.isSetSubEquipment())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            ReferenceType theUncertaintyEvalProc;
            theUncertaintyEvalProc = this.getUncertaintyEvalProc();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "uncertaintyEvalProc", theUncertaintyEvalProc), currentHashCode, theUncertaintyEvalProc, this.isSetUncertaintyEvalProc());
        }
        {
            String theDriftPerUnitTime;
            theDriftPerUnitTime = this.getDriftPerUnitTime();
        ...
        }
        {
            List<EquipmentType.SubEquipment> theSubEquipment;
            theSubEquipment = (this.isSetSubEquipment()?this.getSubEquipment():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "subEquipment", theSubEquipment), currentHashCode, theSubEquipment, this.isSetSubEquipment());
        }
        {
            List<FrequenciesPropertyType> theFrequency;
            theFrequency = (this.isSetFrequency()?this.getFrequency():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof EquipmentType) {
            ...
            {
                Boolean uncertaintyEvalProcShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetUncertaintyEvalProc());
                if (uncertaintyEvalProcShouldBeCopiedAndSet == Boolean.TRUE) {
                    ReferenceType sourceUncertaintyEvalProc;
                    sourceUncertaintyEvalProc = this.getUncertaintyEvalProc();
                    ReferenceType copyUncertaintyEvalProc = ((ReferenceType) strategy.copy(LocatorUtils.property(locator, "uncertaintyEvalProc", sourceUncertaintyEvalProc), sourceUncertaintyEvalProc, this.isSetUncertaintyEvalProc()));
                    copy.setUncertaintyEvalProc(copyUncertaintyEvalProc);
                } else {
                    if (uncertaintyEvalProcShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.uncertaintyEvalProc = null;
                    }
                }
            }
            {
            ...
            {
                Boolean subEquipmentShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSubEquipment());
                if (subEquipmentShouldBeCopiedAndSet == Boolean.TRUE) {
                    List<EquipmentType.SubEquipment> sourceSubEquipment;
                    sourceSubEquipment = (this.isSetSubEquipment()?this.getSubEquipment():null);
                    @SuppressWarnings("unchecked")
                    List<EquipmentType.SubEquipment> copySubEquipment = ((List<EquipmentType.SubEquipment> ) strategy.copy(LocatorUtils.property(locator, "subEquipment", sourceSubEquipment), sourceSubEquipment, this.isSetSubEquipment()));
                    copy.unsetSubEquipment();
                    if (copySubEquipment!= null) {
                        List<EquipmentType.SubEquipment> uniqueSubEquipmentl = copy.getSubEquipment();
                        uniqueSubEquipmentl.addAll(copySubEquipment);
                    }
                } else {
                    if (subEquipmentShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.unsetSubEquipment();
                    }
                }
            }
        ...
        implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
            ...
            final EquipmentType.SubEquipment that = ((EquipmentType.SubEquipment) object);
            {
        ...
        public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
            final Object draftCopy = ((target == null)?createNewInstance():target);
            super.copyTo(locator, draftCopy, strategy);
            if (draftCopy instanceof EquipmentType.SubEquipment) {
                final EquipmentType.SubEquipment copy = ((EquipmentType.SubEquipment) draftCopy);
                {
