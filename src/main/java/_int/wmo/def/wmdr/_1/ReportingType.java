...
public class ReportingType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            BigInteger theNumericalResolution;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            BigInteger lhsNumericalResolution;
            lhsNumericalResolution = this.getNumericalResolution();
            BigInteger rhsNumericalResolution;
        ...
        if (draftCopy instanceof ReportingType) {
            ...
            }
            {
                ...
                if (numericalResolutionShouldBeCopiedAndSet == Boolean.TRUE) {
                    BigInteger sourceNumericalResolution;
                    sourceNumericalResolution = this.getNumericalResolution();
                    BigInteger copyNumericalResolution = ((BigInteger) strategy.copy(LocatorUtils.property(locator, "numericalResolution", sourceNumericalResolution), sourceNumericalResolution, this.isSetNumericalResolution()));
