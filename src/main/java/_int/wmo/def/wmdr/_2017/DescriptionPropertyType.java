...
public class DescriptionPropertyType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DescriptionPropertyType that = ((DescriptionPropertyType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DescriptionPropertyType) {
            final DescriptionPropertyType copy = ((DescriptionPropertyType) draftCopy);
            {
