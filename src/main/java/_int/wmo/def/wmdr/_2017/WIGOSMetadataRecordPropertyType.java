...
public class WIGOSMetadataRecordPropertyType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean isSetWIGOSMetadataRecord() {
        return (this.wigosMetadataRecord!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            WIGOSMetadataRecordType theWIGOSMetadataRecord;
            theWIGOSMetadataRecord = this.getWIGOSMetadataRecord();
            strategy.appendField(locator, this, "wigosMetadataRecord", buffer, theWIGOSMetadataRecord, this.isSetWIGOSMetadataRecord());
        }
        {
            boolean theOwns;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final WIGOSMetadataRecordPropertyType that = ((WIGOSMetadataRecordPropertyType) object);
        {
            WIGOSMetadataRecordType lhsWIGOSMetadataRecord;
            lhsWIGOSMetadataRecord = this.getWIGOSMetadataRecord();
            WIGOSMetadataRecordType rhsWIGOSMetadataRecord;
            rhsWIGOSMetadataRecord = that.getWIGOSMetadataRecord();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "wigosMetadataRecord", lhsWIGOSMetadataRecord), LocatorUtils.property(thatLocator, "wigosMetadataRecord", rhsWIGOSMetadataRecord), lhsWIGOSMetadataRecord, rhsWIGOSMetadataRecord, this.isSetWIGOSMetadataRecord(), that.isSetWIGOSMetadataRecord())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            WIGOSMetadataRecordType theWIGOSMetadataRecord;
            theWIGOSMetadataRecord = this.getWIGOSMetadataRecord();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "wigosMetadataRecord", theWIGOSMetadataRecord), currentHashCode, theWIGOSMetadataRecord, this.isSetWIGOSMetadataRecord());
        }
        {
            boolean theOwns;
            theOwns = (this.isSetOwns()?this.isOwns():false);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof WIGOSMetadataRecordPropertyType) {
            final WIGOSMetadataRecordPropertyType copy = ((WIGOSMetadataRecordPropertyType) draftCopy);
            {
                Boolean wigosMetadataRecordShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetWIGOSMetadataRecord());
                if (wigosMetadataRecordShouldBeCopiedAndSet == Boolean.TRUE) {
                    WIGOSMetadataRecordType sourceWIGOSMetadataRecord;
                    sourceWIGOSMetadataRecord = this.getWIGOSMetadataRecord();
                    WIGOSMetadataRecordType copyWIGOSMetadataRecord = ((WIGOSMetadataRecordType) strategy.copy(LocatorUtils.property(locator, "wigosMetadataRecord", sourceWIGOSMetadataRecord), sourceWIGOSMetadataRecord, this.isSetWIGOSMetadataRecord()));
                    copy.setWIGOSMetadataRecord(copyWIGOSMetadataRecord);
                } else {
                    if (wigosMetadataRecordShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.wigosMetadataRecord = null;
                    }
                }
            }
            {
