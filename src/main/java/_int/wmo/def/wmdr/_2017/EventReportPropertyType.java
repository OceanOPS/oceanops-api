...
public class EventReportPropertyType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean isSetEventReport() {
        return (this.eventReport!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            EventReportType theEventReport;
            theEventReport = this.getEventReport();
            strategy.appendField(locator, this, "eventReport", buffer, theEventReport, this.isSetEventReport());
        }
        {
            boolean theOwns;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final EventReportPropertyType that = ((EventReportPropertyType) object);
        {
            EventReportType lhsEventReport;
            lhsEventReport = this.getEventReport();
            EventReportType rhsEventReport;
            rhsEventReport = that.getEventReport();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "eventReport", lhsEventReport), LocatorUtils.property(thatLocator, "eventReport", rhsEventReport), lhsEventReport, rhsEventReport, this.isSetEventReport(), that.isSetEventReport())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            EventReportType theEventReport;
            theEventReport = this.getEventReport();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "eventReport", theEventReport), currentHashCode, theEventReport, this.isSetEventReport());
        }
        {
            boolean theOwns;
            theOwns = (this.isSetOwns()?this.isOwns():false);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof EventReportPropertyType) {
            final EventReportPropertyType copy = ((EventReportPropertyType) draftCopy);
            {
                Boolean eventReportShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetEventReport());
                if (eventReportShouldBeCopiedAndSet == Boolean.TRUE) {
                    EventReportType sourceEventReport;
                    sourceEventReport = this.getEventReport();
                    EventReportType copyEventReport = ((EventReportType) strategy.copy(LocatorUtils.property(locator, "eventReport", sourceEventReport), sourceEventReport, this.isSetEventReport()));
                    copy.setEventReport(copyEventReport);
                } else {
                    if (eventReportShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.eventReport = null;
                    }
                }
            }
            {
