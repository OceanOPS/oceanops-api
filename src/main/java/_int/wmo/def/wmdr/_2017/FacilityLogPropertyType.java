...
public class FacilityLogPropertyType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final FacilityLogPropertyType that = ((FacilityLogPropertyType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof FacilityLogPropertyType) {
            final FacilityLogPropertyType copy = ((FacilityLogPropertyType) draftCopy);
            {
