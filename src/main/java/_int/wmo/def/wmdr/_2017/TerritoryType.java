...
public class TerritoryType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean isSetTerritoryName() {
        return (this.territoryName!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ReferenceType theTerritoryName;
            theTerritoryName = this.getTerritoryName();
            strategy.appendField(locator, this, "territoryName", buffer, theTerritoryName, this.isSetTerritoryName());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final TerritoryType that = ((TerritoryType) object);
        {
            ReferenceType lhsTerritoryName;
            lhsTerritoryName = this.getTerritoryName();
            ReferenceType rhsTerritoryName;
            rhsTerritoryName = that.getTerritoryName();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "territoryName", lhsTerritoryName), LocatorUtils.property(thatLocator, "territoryName", rhsTerritoryName), lhsTerritoryName, rhsTerritoryName, this.isSetTerritoryName(), that.isSetTerritoryName())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            ReferenceType theTerritoryName;
            theTerritoryName = this.getTerritoryName();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "territoryName", theTerritoryName), currentHashCode, theTerritoryName, this.isSetTerritoryName());
        }
        {
            TimePeriodPropertyType theValidPeriod;
            theValidPeriod = this.getValidPeriod();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TerritoryType) {
            final TerritoryType copy = ((TerritoryType) draftCopy);
            {
                Boolean territoryNameShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTerritoryName());
                if (territoryNameShouldBeCopiedAndSet == Boolean.TRUE) {
                    ReferenceType sourceTerritoryName;
                    sourceTerritoryName = this.getTerritoryName();
                    ReferenceType copyTerritoryName = ((ReferenceType) strategy.copy(LocatorUtils.property(locator, "territoryName", sourceTerritoryName), sourceTerritoryName, this.isSetTerritoryName()));
                    copy.setTerritoryName(copyTerritoryName);
                } else {
                    if (territoryNameShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.territoryName = null;
                    }
                }
            }
            {
