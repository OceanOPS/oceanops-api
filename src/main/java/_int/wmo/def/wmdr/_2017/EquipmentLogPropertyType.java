...
public class EquipmentLogPropertyType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final EquipmentLogPropertyType that = ((EquipmentLogPropertyType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof EquipmentLogPropertyType) {
            final EquipmentLogPropertyType copy = ((EquipmentLogPropertyType) draftCopy);
            {
