...
public class ObservingCapabilityPropertyType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ObservingCapabilityPropertyType that = ((ObservingCapabilityPropertyType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ObservingCapabilityPropertyType) {
            final ObservingCapabilityPropertyType copy = ((ObservingCapabilityPropertyType) draftCopy);
            {
