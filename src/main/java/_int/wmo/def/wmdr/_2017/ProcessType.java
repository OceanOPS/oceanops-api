 ...
 *       &lt;sequence>
 *         &lt;element name="deployment" type="{http://def.wmo.int/wmdr/2017}DeploymentPropertyType" maxOccurs="unbounded"/>
    ...
    extends _int.wmo.def.metce._2013.ProcessType
{
    ...
    protected List<DeploymentPropertyType> deployment;
     ...
     * 
     */
    public List<DeploymentPropertyType> getDeployment() {
        if (deployment == null) {
            deployment = new ArrayList<DeploymentPropertyType>();
        }
