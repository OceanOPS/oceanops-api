...
public class TropicalCyclonePropertyType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final TropicalCyclonePropertyType that = ((TropicalCyclonePropertyType) object);
        {
            TropicalCycloneType lhsTropicalCyclone;
            lhsTropicalCyclone = this.getTropicalCyclone();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TropicalCyclonePropertyType) {
            final TropicalCyclonePropertyType copy = ((TropicalCyclonePropertyType) draftCopy);
            {
                Boolean tropicalCycloneShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTropicalCyclone());
                if (tropicalCycloneShouldBeCopiedAndSet == Boolean.TRUE) {
                    TropicalCycloneType sourceTropicalCyclone;
                    sourceTropicalCyclone = this.getTropicalCyclone();
                    TropicalCycloneType copyTropicalCyclone = ((TropicalCycloneType) strategy.copy(LocatorUtils.property(locator, "tropicalCyclone", sourceTropicalCyclone), sourceTropicalCyclone, this.isSetTropicalCyclone()));
                    copy.setTropicalCyclone(copyTropicalCyclone);
                } else {
