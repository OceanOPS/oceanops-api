...
public class VolcanoPropertyType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            JAXBElement<? extends VolcanoType> theVolcano;
            theVolcano = this.getVolcano();
            strategy.appendField(locator, this, "volcano", buffer, theVolcano, this.isSetVolcano());
        }
        {
            boolean theOwns;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final VolcanoPropertyType that = ((VolcanoPropertyType) object);
        {
            JAXBElement<? extends VolcanoType> lhsVolcano;
            lhsVolcano = this.getVolcano();
            JAXBElement<? extends VolcanoType> rhsVolcano;
            rhsVolcano = that.getVolcano();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "volcano", lhsVolcano), LocatorUtils.property(thatLocator, "volcano", rhsVolcano), lhsVolcano, rhsVolcano, this.isSetVolcano(), that.isSetVolcano())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends VolcanoType> theVolcano;
            theVolcano = this.getVolcano();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "volcano", theVolcano), currentHashCode, theVolcano, this.isSetVolcano());
        }
        {
            boolean theOwns;
            theOwns = (this.isSetOwns()?this.isOwns():false);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof VolcanoPropertyType) {
            final VolcanoPropertyType copy = ((VolcanoPropertyType) draftCopy);
            {
                Boolean volcanoShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetVolcano());
                if (volcanoShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends VolcanoType> sourceVolcano;
                    sourceVolcano = this.getVolcano();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends VolcanoType> copyVolcano = ((JAXBElement<? extends VolcanoType> ) strategy.copy(LocatorUtils.property(locator, "volcano", sourceVolcano), sourceVolcano, this.isSetVolcano()));
                    copy.setVolcano(copyVolcano);
                } else {
                    if (volcanoShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.volcano = null;
                    }
                }
            }
