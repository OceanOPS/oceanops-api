...
public class EruptingVolcanoPropertyType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean isSetEruptingVolcano() {
        return (this.eruptingVolcano!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            EruptingVolcanoType theEruptingVolcano;
            theEruptingVolcano = this.getEruptingVolcano();
            strategy.appendField(locator, this, "eruptingVolcano", buffer, theEruptingVolcano, this.isSetEruptingVolcano());
        }
        {
            boolean theOwns;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final EruptingVolcanoPropertyType that = ((EruptingVolcanoPropertyType) object);
        {
            EruptingVolcanoType lhsEruptingVolcano;
            lhsEruptingVolcano = this.getEruptingVolcano();
            EruptingVolcanoType rhsEruptingVolcano;
            rhsEruptingVolcano = that.getEruptingVolcano();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "eruptingVolcano", lhsEruptingVolcano), LocatorUtils.property(thatLocator, "eruptingVolcano", rhsEruptingVolcano), lhsEruptingVolcano, rhsEruptingVolcano, this.isSetEruptingVolcano(), that.isSetEruptingVolcano())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            EruptingVolcanoType theEruptingVolcano;
            theEruptingVolcano = this.getEruptingVolcano();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "eruptingVolcano", theEruptingVolcano), currentHashCode, theEruptingVolcano, this.isSetEruptingVolcano());
        }
        {
            boolean theOwns;
            theOwns = (this.isSetOwns()?this.isOwns():false);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof EruptingVolcanoPropertyType) {
            final EruptingVolcanoPropertyType copy = ((EruptingVolcanoPropertyType) draftCopy);
            {
                Boolean eruptingVolcanoShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetEruptingVolcano());
                if (eruptingVolcanoShouldBeCopiedAndSet == Boolean.TRUE) {
                    EruptingVolcanoType sourceEruptingVolcano;
                    sourceEruptingVolcano = this.getEruptingVolcano();
                    EruptingVolcanoType copyEruptingVolcano = ((EruptingVolcanoType) strategy.copy(LocatorUtils.property(locator, "eruptingVolcano", sourceEruptingVolcano), sourceEruptingVolcano, this.isSetEruptingVolcano()));
                    copy.setEruptingVolcano(copyEruptingVolcano);
                } else {
                    if (eruptingVolcanoShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.eruptingVolcano = null;
                    }
                }
            }
            {
