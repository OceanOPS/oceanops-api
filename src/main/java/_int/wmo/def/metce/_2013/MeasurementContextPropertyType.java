...
public class MeasurementContextPropertyType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean isSetMeasurementContext() {
        return (this.measurementContext!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            MeasurementContextType theMeasurementContext;
            theMeasurementContext = this.getMeasurementContext();
            strategy.appendField(locator, this, "measurementContext", buffer, theMeasurementContext, this.isSetMeasurementContext());
        }
        {
            boolean theOwns;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MeasurementContextPropertyType that = ((MeasurementContextPropertyType) object);
        {
            MeasurementContextType lhsMeasurementContext;
            lhsMeasurementContext = this.getMeasurementContext();
            MeasurementContextType rhsMeasurementContext;
            rhsMeasurementContext = that.getMeasurementContext();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "measurementContext", lhsMeasurementContext), LocatorUtils.property(thatLocator, "measurementContext", rhsMeasurementContext), lhsMeasurementContext, rhsMeasurementContext, this.isSetMeasurementContext(), that.isSetMeasurementContext())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MeasurementContextType theMeasurementContext;
            theMeasurementContext = this.getMeasurementContext();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "measurementContext", theMeasurementContext), currentHashCode, theMeasurementContext, this.isSetMeasurementContext());
        }
        {
            boolean theOwns;
            theOwns = (this.isSetOwns()?this.isOwns():false);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MeasurementContextPropertyType) {
            final MeasurementContextPropertyType copy = ((MeasurementContextPropertyType) draftCopy);
            {
                Boolean measurementContextShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMeasurementContext());
                if (measurementContextShouldBeCopiedAndSet == Boolean.TRUE) {
                    MeasurementContextType sourceMeasurementContext;
                    sourceMeasurementContext = this.getMeasurementContext();
                    MeasurementContextType copyMeasurementContext = ((MeasurementContextType) strategy.copy(LocatorUtils.property(locator, "measurementContext", sourceMeasurementContext), sourceMeasurementContext, this.isSetMeasurementContext()));
                    copy.setMeasurementContext(copyMeasurementContext);
                } else {
                    if (measurementContextShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.measurementContext = null;
                    }
                }
            }
            {
