...
public class ObservablePropertyPropertyType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            JAXBElement<? extends ObservablePropertyType> lhsObservableProperty;
        ...
        if (draftCopy instanceof ObservablePropertyPropertyType) {
            final ObservablePropertyPropertyType copy = ((ObservablePropertyPropertyType) draftCopy);
            {
                ...
                if (observablePropertyShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends ObservablePropertyType> sourceObservableProperty;
                    sourceObservableProperty = this.getObservableProperty();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends ObservablePropertyType> copyObservableProperty = ((JAXBElement<? extends ObservablePropertyType> ) strategy.copy(LocatorUtils.property(locator, "observableProperty", sourceObservableProperty), sourceObservableProperty, this.isSetObservableProperty()));
