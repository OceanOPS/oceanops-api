...
public class AbstractObservablePropertyPropertyType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final AbstractObservablePropertyPropertyType that = ((AbstractObservablePropertyPropertyType) object);
        {
            JAXBElement<? extends AbstractObservablePropertyType> lhsAbstractObservableProperty;
            lhsAbstractObservableProperty = this.getAbstractObservableProperty();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof AbstractObservablePropertyPropertyType) {
            final AbstractObservablePropertyPropertyType copy = ((AbstractObservablePropertyPropertyType) draftCopy);
            {
                Boolean abstractObservablePropertyShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractObservableProperty());
                if (abstractObservablePropertyShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractObservablePropertyType> sourceAbstractObservableProperty;
                    sourceAbstractObservableProperty = this.getAbstractObservableProperty();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends AbstractObservablePropertyType> copyAbstractObservableProperty = ((JAXBElement<? extends AbstractObservablePropertyType> ) strategy.copy(LocatorUtils.property(locator, "abstractObservableProperty", sourceAbstractObservableProperty), sourceAbstractObservableProperty, this.isSetAbstractObservableProperty()));
                    copy.setAbstractObservableProperty(copyAbstractObservableProperty);
                } else {
