...
public class QualifiedObservablePropertyPropertyType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean isSetQualifiedObservableProperty() {
        return (this.qualifiedObservableProperty!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            QualifiedObservablePropertyType theQualifiedObservableProperty;
            theQualifiedObservableProperty = this.getQualifiedObservableProperty();
            strategy.appendField(locator, this, "qualifiedObservableProperty", buffer, theQualifiedObservableProperty, this.isSetQualifiedObservableProperty());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final QualifiedObservablePropertyPropertyType that = ((QualifiedObservablePropertyPropertyType) object);
        {
            QualifiedObservablePropertyType lhsQualifiedObservableProperty;
            lhsQualifiedObservableProperty = this.getQualifiedObservableProperty();
            QualifiedObservablePropertyType rhsQualifiedObservableProperty;
            rhsQualifiedObservableProperty = that.getQualifiedObservableProperty();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "qualifiedObservableProperty", lhsQualifiedObservableProperty), LocatorUtils.property(thatLocator, "qualifiedObservableProperty", rhsQualifiedObservableProperty), lhsQualifiedObservableProperty, rhsQualifiedObservableProperty, this.isSetQualifiedObservableProperty(), that.isSetQualifiedObservableProperty())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            QualifiedObservablePropertyType theQualifiedObservableProperty;
            theQualifiedObservableProperty = this.getQualifiedObservableProperty();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "qualifiedObservableProperty", theQualifiedObservableProperty), currentHashCode, theQualifiedObservableProperty, this.isSetQualifiedObservableProperty());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof QualifiedObservablePropertyPropertyType) {
            final QualifiedObservablePropertyPropertyType copy = ((QualifiedObservablePropertyPropertyType) draftCopy);
            {
                Boolean qualifiedObservablePropertyShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetQualifiedObservableProperty());
                if (qualifiedObservablePropertyShouldBeCopiedAndSet == Boolean.TRUE) {
                    QualifiedObservablePropertyType sourceQualifiedObservableProperty;
                    sourceQualifiedObservableProperty = this.getQualifiedObservableProperty();
                    QualifiedObservablePropertyType copyQualifiedObservableProperty = ((QualifiedObservablePropertyType) strategy.copy(LocatorUtils.property(locator, "qualifiedObservableProperty", sourceQualifiedObservableProperty), sourceQualifiedObservableProperty, this.isSetQualifiedObservableProperty()));
                    copy.setQualifiedObservableProperty(copyQualifiedObservableProperty);
                } else {
                    if (qualifiedObservablePropertyShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.qualifiedObservableProperty = null;
                    }
                }
            }
            {
